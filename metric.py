...
def calc(vi: Tensor, ir: Tensor, fu: Tensor) -> dict[str, float]:
    return {
        'SF': calc_SF(fu).item(), # Higher is better
        'EN': calc_EN(fu).item(), # Higher is better
        'AG': calc_AG(fu).item(), # Higher is better
        'SD': calc_SD(fu).item(), # Larger is not always better; interpret in context
        'CE': calc_CE(vi, ir, fu).item(), # Lower is better
        'CC': calc_CC(vi, ir, fu).item(), # Higher is better
        'SCD': calc_SCD(vi, ir, fu).item(), # Higher is better; it is ideally positive
        'MSE': calc_MSE(vi, ir, fu).item(), # Lower is better
        'MI': calc_MI(vi, ir, fu).item(), # Higher is better
        'PSNR': calc_PSNR(vi, ir, fu).item(), # Higher is better
        'Qabf': calc_Qabf(vi, ir, fu).item(), # Higher is better
        'VIF': calc_VIF(vi, ir, fu).item(), # Higher is better
        'MS-SSIM': calc_MS_SSIM(vi, ir, fu).item() # Higher is better
    }
